...
(function() {
  ...
  window.BUTLINS = {
    ...
    modaleCss: function() {
            ...
            bstyle.innerHTML = ' .moto {display:none;}  ';
    ...
    createModal: function() {
        ...
        '<div id="newsOffers" class="modal" />' +
          '<div class="modal-content only-v1">' +
              ...
              '<form action="/h5/contacts-hub?pagePath=https%3A%2F%2Fwww.bigweekends.com%2Flinks%2Fother-links%2Fkeep-me-updated%2Findex.aspx%3Femailaddress%3D" method="post" _lpchecked="1" target="my_iframe_feedback">'+
