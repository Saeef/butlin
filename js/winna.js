            ...
            if(modal !== undefined){
              ...
              if($(innerForm).find('form .UNErrorColor').length > 0){
                ...
                if(error.html() !== $('.UNErrorColor').html()){
                  ...
                  $('.modal-content').removeClass('loader-active');
                  $('.modal-content form').removeClass('submit');
                ...
                $('.m-desc').text('You’ve been added to our mailing list and will hear from us shortly.');
    ...
    createModal: function() {
        ...
        '<div id="newsOffers" class="modal" />' +
          '<div class="modal-content only-v1">' +
              ...
              '<div class="m-desc">Sign up to hear about our latest news and offers.</div>' +
    ...
    bindEvents: function() {
      ...
      $('form[target="my_iframe_feedback"]').submit(function(e) {
        if(!FormSubmited){
          ...
          $('.modal-content').addClass('loader-active');
          $('.modal-content form').addClass('submit');
